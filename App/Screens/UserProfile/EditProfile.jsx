...
const EditProfile = ({ navigation }) => {
    ...
    const fetchUserDetails = async () => {
        try {
            const response = await axios.get('https://90ea-2a09-bac1-4300-00-279-78.ngrok-free.app/api/users/fullname_email');
    ...
    const handleSubmit = async () => {
        if (validate()) {
            ...
            try {
                ...
                const response = await axios.put('https://90ea-2a09-bac1-4300-00-279-78.ngrok-free.app/api/users/update', data, {
                    headers: {
