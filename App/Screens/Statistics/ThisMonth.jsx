...
export default function ThisMonth() {
    ...
    const fetchMonthTotal = async () => {
        axios.get(` https://ef7a-2402-4000-2180-9088-e95f-5682-e8eb-bdde.ngrok-free.app//api/statistics/thisMonthTotal`)
            .then(response => {
    ...
    const fetchMonthStat = async () => {
        axios.get(` https://ef7a-2402-4000-2180-9088-e95f-5682-e8eb-bdde.ngrok-free.app//api/statistics/thisMonthStat`)
            .then(response => {
