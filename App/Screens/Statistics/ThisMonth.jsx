...
export default function ThisMonth() {
    ...
    const fetchMonthTotal = async () => {
        axios.get(`https://0434-2a09-bac5-4862-137d-00-1f1-1db.ngrok-free.app/api/statistics/thisMonthTotal`)
            .then(response => {
    ...
    const fetchMonthStat = async () => {
        axios.get(`https://0434-2a09-bac5-4862-137d-00-1f1-1db.ngrok-free.app/api/statistics/thisMonthStat`)
            .then(response => {
