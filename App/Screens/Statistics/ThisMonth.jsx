...
export default function ThisMonth() {
    ...
    const fetchMonthTotal = async () => {
        try {
            const response = await axios.get(`https://a88d-2a09-bac5-4860-101e-00-19b-111.ngrok-free.app/api/statistics/thisMonthTotal`);
    ...
    const fetchMonthStat = async () => {
        try {
            const response = await axios.get(`https://a88d-2a09-bac5-4860-101e-00-19b-111.ngrok-free.app/api/statistics/thisMonthStat`);
