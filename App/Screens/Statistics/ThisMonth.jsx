...
export default function ThisMonth() {
    ...
    const fetchMonthTotal = async () => {
        ...
        axios.get(`http://192.168.99.230:8005/api/statistics/thisMonthTotal?userID=${userID}`)
            .then(response => {
    ...
    const fetchMonthStat = async () => {
        let userID = await AsyncStorage.getItem("userID");
        axios.get(`http://192.168.30.230:8005/api/statistics/thisMonthStat?userID=${userID}`)
            .then(response => {
