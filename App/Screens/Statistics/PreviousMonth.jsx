...
export default function ThisMonth() {
    ...
    const fetchMonthTotal = async () => {
        try {
            const response = await axios.get(`https://0579-2a09-bac5-4863-1028-00-19c-47.ngrok-free.app/api/statistics/previousMonthTotal`);
    ...
    const fetchMonthStat = async () => {
        try {
            const response = await axios.get(`https://0579-2a09-bac5-4863-1028-00-19c-47.ngrok-free.app/api/statistics/previousMonthStat`);
