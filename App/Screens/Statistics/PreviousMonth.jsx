...
export default  function PreviousMonth() {
    ...
    const fetchMonthTotal = async () => {
        ...
        axios.get(`http://192.168.99.230:8005/api/statistics/previousMonthTotal?userID=${userID}`)
            .then(response => {
    ...
    const fetchMonthStat = async () => {
        let userID = await AsyncStorage.getItem("userID");
        axios.get(`http://192.168.30.230:8005/api/statistics/previousMonthStat?userID=${userID}`)
            .then(response => {
