...
export default function PreviousMonth() {
    ...
    const fetchMonthTotal = async () => {
        axios.get(`https://8dd8-175-157-13-142.ngrok-free.app/api/statistics/previousMonthTotal`)
            .then(response => {
    ...
    const fetchMonthStat = async () => {
        axios.get(`https://8dd8-175-157-13-142.ngrok-free.app/api/statistics/previousMonthStat`)
            .then(response => {
