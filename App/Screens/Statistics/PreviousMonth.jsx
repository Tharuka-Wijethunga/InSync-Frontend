...
export default function ThisMonth() {
    ...
    const fetchMonthTotal = async () => {
        try {
            const response = await axios.get(`http://192.168.248.230:8006/api/statistics/previousMonthTotal`);
    ...
    const fetchMonthStat = async () => {
        try {
            const response = await axios.get(`http://192.168.248.230:8006/api/statistics/previousMonthStat`);
