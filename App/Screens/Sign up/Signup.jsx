                    ...
                    <VStack space={4} alignItems="center" width="100%" >
                        ...
                        <Modal isOpen={showModal} onClose={() => setShowModal(false)}>
                            <Modal.Content borderRadius={30}>
                                ...
                                <Button variant="outline" colorScheme="red" onPress={() => setShowModal(false)}>Close</Button>
                            </Modal.Content>
                        </Modal>
                        <Input marginTop={-2}
                               variant="rounded"
                        ...
                        <HStack alignItems="center" mt={5}>
                            <Checkbox value="isChecked" isChecked={isChecked} onChange={(val) => setIsChecked(val)} colorScheme={"blue"}>
                                <Text fontSize={11}>By checking the box you agree to our <Text color={Colors.Blue}> Terms </Text>and<Text color={Colors.Blue}> Conditions. </Text></Text>
                            </Checkbox>
                        </HStack>
