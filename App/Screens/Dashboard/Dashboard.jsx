...
export default function Dashboard() {
    ...
    useEffect(()=> {
        if(isFocused){
            fetch_Records();
            axios.get('https://4219-2a09-bac5-4864-18c8-00-278-33.ngrok-free.app/api/dashboard/account?type=cash')
                .then(response => {
            ...
            axios.get('https://4219-2a09-bac5-4864-18c8-00-278-33.ngrok-free.app/api/dashboard/account?type=bank')
                .then(response => {
            ...
            axios.get('https://4219-2a09-bac5-4864-18c8-00-278-33.ngrok-free.app/api/dashboard/today_spending')
                .then(response=> {
